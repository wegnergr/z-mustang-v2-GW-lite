...
function viewCurrentContact() {
    ...
    document.getElementById("favoriteHobby").value = currentContact.favoriteHobby;  
    document.getElementById("biggestFear").value = currentContact.biggestFear;  
